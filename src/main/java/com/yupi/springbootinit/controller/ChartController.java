...
//     */
//    @PostMapping("/testgen")
//    public BaseResponse<String> testgen(@RequestPart("file") MultipartFile multipartFile,GenChartByAiRequest genChartByAiRequest,
//                                       HttpServletRequest request) {
//
//        //从请求头中获取信息
...
//                                       }
    ...
    public BaseResponse<BiResponse> genChartByAi(@RequestPart("file") MultipartFile multipartFile,
        ...
        final List<String> validFileSuffixList = Arrays.asList("xlsx", "xls","csv","json");
...
//        queryWrapper.eq(StringUtils.isNotBlank(goal), "goal", goal);
    ...
    public String handleFileUpload (@RequestPart("file")MultipartFile file) throws IOException {
        ...
        if(!file.isEmpty()){
            ...
            File targetFile = new File("/usr/local/alvinbi", filename);
